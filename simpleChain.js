...
// Wrapper functions for level DB in this class
class BlockchainDbWrapper {
    constructor(dbDir) {
        this.db = level(dbDir);
    }
    getDb() {
...
//Actual blockchain class to envision a realistic but simplistic blockchain in an ideal world
class Blockchain{
    constructor(db){
        this.chain = db || new BlockchainDbWrapper("./mydb");
